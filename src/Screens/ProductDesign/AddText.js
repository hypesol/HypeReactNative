...
export default class AddText extends Component {
  ...
  _onApplyText() {
    ...
    setTimeout(() => {
      this.props.navigation.navigate('CoverEditor', {
        addedtext: text,
        fontcolor: this.props.navigation.getParam('fontColor')
          ? this.props.navigation.getParam('fontColor')
          : '#000000',
  ...
  componentDidMount() {
    this.props.navigation.setParams({
      onApplyText: this._onApplyText.bind(this),
    });
  }
    ...
    return (
      <View
        ...
        <TouchableOpacity
          ...
          <Text style={[styles.TextStyle, {fontFamily: cell}]}>
            Hello World
          </Text>
        </TouchableOpacity>
      </View>
    ...
    return (
      <View style={styles.container}>
        <View style={styles.headerInput}>
          <View style={styles.input}>
            <TextInput
              ...
              <Text
                style={{
                  color: this.props.navigation.getParam('fontColor')
                    ? this.props.navigation.getParam('fontColor')
                    : 'black',
          ...
          <TouchableOpacity
            onPress={() => {
              this.props.navigation.navigate('FontColorPicker');
            }}
            style={styles.apply}>
        ...
        <FlatList
          ...
          renderItem={_renderCell.bind(this)}
          numColumns={3}
